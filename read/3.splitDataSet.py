...
df = pd.DataFrame(pd.read_csv(tsv_dir + '/TCGA-READ.muse_snv.tsv', sep='	'))

qt_dir = 'D:/read/filtered'
...
# 得到前#个病例
highTMB = set(e[0] for e in arr[:13]) # the number of high TMB cases are calculated from R script
#lowTMB = set(e[0] for e in arr[13:26])
