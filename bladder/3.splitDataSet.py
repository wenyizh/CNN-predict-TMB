...
df = pd.DataFrame(pd.read_csv(tsv_dir + '/TCGA-BLCA.muse_snv.tsv', sep='	'))

qt_dir = 'D:/bladder_data/filtered'
...
# 得到前#个病例
highTMB = set(e[0] for e in arr[:41]) # the number of high TMB cases are calculated from R script
